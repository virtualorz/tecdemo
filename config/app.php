...
return [
    ...
    'providers' => [
         ...
         * Custom Classes
         */
        App\Classes\Sitemap\SitemapServiceProvider::class,
    ...
    'aliases' => [
         ...
         */
        'Sitemap' => App\Facades\Sitemap::class,
        'SitemapAccess' => App\Classes\Sitemap\SitemapAccess::class,
        'DBProcedure' => App\Facades\DBProcedure::class,
        'DBOperator' => App\Classes\DB\DBOperator::class,
