    ...
    public function detail() {
        ...
        $dataResult = DB::table('instrument_reservation_data')
                            ->select('instrument_reservation_data.*',
                                        DB::raw('DATE_FORMAT(instrument_reservation_data.created_at, "%Y/%m/%d %H:%i:%s") as created_at'),
                                        DB::raw('DATE_FORMAT(instrument_reservation_data.reservation_dt, "%Y/%m/%d") as reservation_dt'),
                                        DB::raw('DATE_FORMAT(instrument_reservation_data.use_dt_start, "%Y/%m/%d %H:%i") as use_dt_start'),
                                        DB::raw('DATE_FORMAT(instrument_reservation_data.use_dt_end, "%Y/%m/%d %H:%i") as use_dt_end'),
                                        DB::raw('DATE_FORMAT(instrument_section.start_time, "%H:%i") as start_time'),
                                        DB::raw('DATE_FORMAT(instrument_section.end_time, "%H:%i") as end_time'),
                                        'instrument_data.instrument_id',
                                        'instrument_data.name',
