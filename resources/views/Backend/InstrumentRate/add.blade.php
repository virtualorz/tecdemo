                    ...
                    <table class="table datatable_simple nohead">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="check"><input type="radio" name="rate_type" id="data_rate_type_1" class="iradio required" value="1" checked /> {{ trans('enum.rate_type.1') }}</label>
                                    <label class="check"><input type="radio" name="rate_type" id="data_rate_type_2" class="iradio required" value="2" /> {{ trans('enum.rate_type.2') }}</label> 
                                    <label class="check"><input type="radio" name="rate_type" id="data_rate_type_3" class="iradio required" value="3" /> {{ trans('enum.rate_type.3') }}</label> 
                                </td>
                            </tr>  
                            <tr>
                                <th><span class="red">*</span>{{ trans('validation.attributes.rate1') }}</th>
                                <td>
                                    <input type="number" name="member_1" id="data-member_1" class="form-control required">
                                </td>
                            </tr> 
                            <tr>
                                <th><span class="red">*</span>{{ trans('validation.attributes.rate2') }}</th>
                                <td>
                                    <input type="number" name="member_2" id="data-member_2" class="form-control required">
                                </td>
                            </tr> 
                            <tr>
                                <th><span class="red">*</span>{{ trans('validation.attributes.rate3') }}</th>
                                <td>
                                    <input type="number" name="member_3" id="data-member_3" class="form-control required">
                                </td>
                            </tr> 
                            <tr>
                                <th><span class="red">*</span>{{ trans('validation.attributes.rate4') }}</th>
                                <td>
                                    <input type="number" name="member_4" id="data-member_4" class="form-control required">
                                </td>
                            </tr>  
                            <tr>
                                <th><span class="red">*</span>{{ trans('validation.attributes.rate_multi') }}</th>
                                <td>
                                    <input type="number" name="rate" id="data-rate" class="form-control required">
                                </td>
                            </tr> 
                            <tr>
