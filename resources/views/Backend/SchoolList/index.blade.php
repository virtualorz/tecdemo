                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="location" id="data-location" class="form-control required">
                                        ...
                                        <option value="{{$k}}" @if($k == Request::input('location', '')) selected @endif>{{$v}}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                ...
                <table class="table datatable_simple table_responsive">
                    <thead>
                        <tr>
                            ...
                            <th width="15%">{{ trans('validation.attributes.location') }}</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $v['created_at'] }}</td>
                            <td>{{ $location[$v['location']] }}</td>
                            <td>{{ $twCity[$v['city']] }}/{{ $twTown[$v['city']][$v['town']][1] }}</td>
                            <td>{{ $v['school_name'] }}</td>
                            <td>
