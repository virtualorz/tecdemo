                ...
                @if(count($dataResult) > 0)
                    <table class="table datatable_simple nohead">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>{{ trans('validation.attributes.learning_time') }}</th>
                                <td>
                                    {{ $dataResult['date'] }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>{{ trans('validation.attributes.learning_member') }}</th>
                                <td>
                                    {{ $dataResult['member'] }}
                                </td>
                            </tr>
                            <tr>
                                <th>{{ trans('validation.attributes.learning_content') }}</th>
                                <td>
                            ...
                            <tr>
                                <th>{{ trans('validation.attributes.learning_file') }}</th>
                                <td>
                            ...
                            <tr>
                                <th>{{ trans('validation.attributes.learning_photo') }}</th>
                                <td>
