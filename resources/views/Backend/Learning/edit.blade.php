                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select name="school_id" id="data-school_id" class="form-control required">
                                        ...
                                        @endforeach
                                        <option value='-1' @if($dataResult['school_id'] == null) selected @endif>其他學校</option>
                                    </select>
                                    <span id="school_others_span" @if($dataResult['school_id'] != null) style="display:none" @endif>
                                    {{ trans('validation.attributes.school_others') }}:
                                    <input type="text" name="school_others" id="data-school_others" class="form-control" value="{{ $dataResult['school_others'] }}">
                                    </span>
                                </td>
                            </tr>
                            <tr>
