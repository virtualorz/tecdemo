                ...
                <form id="form1" method="post" action="{{ Sitemap::node()->getChildren('submit')->getUrl() }}">
                    <table class="table datatable_simple nohead">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th><span class="red">*</span>{{ trans('validation.attributes.video_date') }}</th>
                                <td>
                                    <input type="text" name="date" id="data-date" class="form-control required datepicker" value="{{date('Y/m/d')}}">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th><span class="red">*</span>{{ trans('validation.attributes.video_url') }}</th>
                                <td>
