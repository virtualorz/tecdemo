                    ...
                    <table class="table datatable_simple nohead">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="email" name="email" id="data-email" class="form-control required" value="{{ $dataResult['email'] }}">
                                </td>
                            </tr>
                            <tr>
                                <th><span class="red">*</span>{{ trans('validation.attributes.phone') }}</th>
                                <td>
                                    <input type="tel" name="phone" id="data-phone" class="form-control required" pattern="^[0-9#,\(\)\- ]+$" value="{{ $dataResult['phone'] }}">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="tel" name="contact_phone" id="data-contact_phone" class="form-control required" pattern="^[0-9#,\(\)\- ]+$" value="{{ $dataResult['contact_phone'] }}">
                                </td>
                            </tr>
                            <tr>
                                <th><span class="red">*</span>{{ trans('validation.attributes.email-contact') }}</th>
                                <td>
                                    <input type="email" name="contact_email" id="data-contact_email" class="form-control required" value="{{ $dataResult['contact_email'] }}">
                                </td>
                            </tr>
                            <tr>
