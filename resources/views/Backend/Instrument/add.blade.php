                    ...
                    <table class="table datatable_simple nohead">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="instrument_id" id="data-instrument_id" class="form-control required" pattern="^[A-za-z0-9#,\(\)\-_ ]+$">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea name="function" id="data-function" class="form-control required"></textarea>
                                </td>
                            </tr>
                            <tr>
                                   ...
                                   <table class="table datatable_simple">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                @if($v['1'] != '')
                                                    <label class="check"><input type="checkbox" name="open_section[]" class="icheckbox ckbItem_open_section" value="{{$v['1']['id']}}_{{$v['1']['section_type']}}" />{{$v['1']['start_time']}} - {{$v['1']['end_time']}}</label>
                                                @endif
                                                </td>
                                                <td>
                                                @if($v['2'] != '')
                                                    <label class="check"><input type="checkbox" name="open_section[]" class="icheckbox ckbItem_open_section" value="{{$v['2']['id']}}_{{$v['2']['section_type']}}" />{{$v['2']['start_time']}} - {{$v['2']['end_time']}}</label>
                                                @endif
                                                </td>
                                            </tr>
                                            @endforeach
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" name="reservation_limit" id="data-reservation_limit" class="form-control required">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div>                  
                                        <label class="check"><input type="radio" name="notice" id="data_notice_1" class="iradio required" value="1" checked /> {{ trans('enum.yn.1') }}</label>
                                        <label class="check"><input type="radio" name="notice" id="data_notice_0" class="iradio required" value="0" /> {{ trans('enum.yn.0') }}</label> 
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="cancel_limit" id="data-cancel_limit" class="form-control required">
                                        <option value="">{{trans('page.text.select_item')}}</option>
                                        @for($i = 1; $i <= 5; $i++)
                                        <option value="{{$i}}" >{{$i}}{{trans('page.text.days')}}</option>
                                        @endfor
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div>                  
                                        <label class="check"><input type="radio" name="cancel_notice" id="data_cancel_notice_1" class="iradio required" value="1" checked /> {{ trans('enum.yn.1') }}</label>
                                        <label class="check"><input type="radio" name="cancel_notice" id="data_cancel_notice_0" class="iradio required" value="0" /> {{ trans('enum.yn.0') }}</label> 
                                    </div>
                                </td>
                            </tr>
                            <tr>
