...
">
    ...
    border-bottom: 1px solid #1e6ea2" class="top" width="100%"  align="left" cellpadding="0" cellspacing="0" >
                  <!-- First header column with Logo -->
                  	<tbody>
                    <tr>
                      <td style="font-size: 12px; color:#929292; text-align:center; font-family: sans-serif;"><img src="{{$message->embed(asset('assets/official/img/logo_mn.png'))}}" width="120" height="50" alt=""/>
                      </td>
                    </tr>
                  	</tbody>
              	 	</table>
