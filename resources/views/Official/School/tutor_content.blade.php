    ...
    <div class="container">
        <div class="row">
            ...
            <div id="visitdetail-content" class="col-md-10 col-sm-9 col-xs-12">
       	    	<div class="bigtitle">
                	<img src="{{ asset('assets/official/img/title_visit.png') }}" width="225" height="40" alt=""/>
                </div>
                ...
                <h3 class="color_green">訪視委員</h3>
                <p>{{ $dataResult[0]['member'] }}</p>
                
                <span class="line-schoolpage"></span>
                
              	<h3 class="color_green">訪視紀錄</h3>
                ...
                <div class="row text-center">
                    <div class="col-md-12 text-center">
                        <a href="{{ asset('school/tutor/id-'.$dataResult[0]['school_id']) }}" class="btn btn-default btn-lg"><i class="fa fa-angle-left" aria-hidden="true"></i> 上一頁</a>
                    </div>
                </div>
