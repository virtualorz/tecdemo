        ...
        <div class="row">
            ...
            <div id="visitdetail-content" class="col-md-10 col-sm-9 col-xs-12 edit-content">
                ...
                <span class="line-schoolpage"></span>
                    ...
                    <a href="{{ asset('member/execute/add') }}" class="btn btn-primary btn-lg">
                    	<i class="fa fa-plus" aria-hidden="true"></i> 新增執行情形
                    </a>
                </div>
              	<span class="line-schoolpage"></span>
                <table class="table table-striped"> 
               		<thead> 
                    	<tr> <th>#</th> <th>日期</th><th style="width:100px">功能</th> </tr> 
                    </thead> 
                    ...
                    <tbody> 
                    	...
                    	<tr> 
                       	  <th scope="row">{{ $k+1 }}</th> 
                       	  <td><a href="{{ asset('school/execute/content/id-'.$v['id'])}}" target="_blank">{{ $v['date'] }}</a></td> 
                            <td>
                           	  <div class="width50 floatleft text-center">
                                <a href="{{ asset('member/execute/edit/id-'.$v['id'])}}"> <i class="fa fa-pencil" aria-hidden="true"></i></a>
                              </div>
                              <div class="width50 floatleft text-center">
