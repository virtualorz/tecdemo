            ...
            <div id="visitdetail-content" class="col-md-10 col-sm-9 col-xs-12">
                ...
                <form id="form1" class="form-horizontal" method="post" action="{{ Sitemap::node()->getChildren('submit')->getUrl() }}">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="date" id="data-date" class="form-control datepicker required"  value="{{ $dataEditResult['date']}}">
                        </div>
                    </div>
                ...
                <span class="line-schoolpage"></span>
                	...
                	<div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control required" name="member" id="data-member" value="{{ $dataEditResult['member']}}">
                        </div>
                    </div>
                ...
                <span class="line-schoolpage"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                        <div name="content" id="content" class="btseditor" data-name="content" data-value="{{ $dataEditResult['content'] }}"></div>
                        </div>
                    </div>
               <span class="line-schoolpage"></span> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            @foreach($dataEditResult['file'] as $k=>$v)
                            <span class='files'>
                                ...
                                <input type='hidden' name='file[{{ $v["id"] }}][scale]' value='{{ $v["scale"] }}'>
                ...
                <span class="line-schoolpage"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          	...
                          	<p>上傳解析度 : 960 * 720</p>
                              @foreach($dataEditResult['photo'] as $k=>$v)
                              @if($k%2 == 0)
                              <div class="school-visitpic">
                              @endif
                                <div class="col-sm-6 col-xs-12">
                                    <input type='hidden' name='photo[{{ $v["id"] }}][id]' value='{{ $v["id"] }}'>
                                    <input type='hidden' name='photo[{{ $v["id"] }}][name]' value='{{ $v["name"] }}'>
                                    <input type='hidden' name='photo[{{ $v["id"] }}][ext]' value='{{ $v["ext"] }}'>
                                    <input type='hidden' name='photo[{{ $v["id"] }}][dir]' value='{{ $v["dir"] }}'>
                                    <input type='hidden' name='photo[{{ $v["id"] }}][scale]' value='{{ $v["scale"] }}'>
                                    <img class="img-responsive" src="{{ $v['url'] }}" alt="">
                                    <input type="text" class="form-control mb--s" name="photo_text[{{ $v['id'] }}]" value="{{ $dataEditResult['photo_text'][$k] }}">
                                </div>
                              @if($k%2 == 1 || ($k%2 == 0 && $k == count($dataEditResult['photo'])))
                              </div>
                              @endif
                              @endforeach
                ...
                <input type="hidden" name="id" value="{{ $dataEditResult['id'] }}" />
                </form>
