...
<div class="contentmt">    
    ...
    <div class="container">
        <div class="row">
            ...
            <div id="visitdetail-content" class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
       	    	<div class="bigtitle">
                	<img src="{{ asset('assets/official/img/title_learning.png') }}" width="225" height="40" alt=""/>
                </div>
                ...
                <p>{{ $dataResult[0]['date'] }} {{ $twCity[$dataResult[0]['learning_city']] }} {{ $dataResult[0]['school_name'] }}</p>
                ...
                <h3 class="color_green">研習紀錄</h3>
            	@if(isset($dataResult[0]['content']))
                @include('backend.elements.btseditor', ['btseditorContent' => $dataResult[0]['content']])
                @endif
                
                <span class="line-schoolpage"></span>
                
                <h3 class="color_green">相關手冊</h3>
                ...
                <div class="row text-center">
                    <div class="col-md-12 text-center">
                        <a href="{{ asset('learning') }}" class="btn btn-default btn-lg"><i class="fa fa-angle-left" aria-hidden="true"></i> 上一頁</a>
                    </div>
                </div>
            </div>
        </div>
