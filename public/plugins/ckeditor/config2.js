...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.filebrowserBrowseUrl = CKEDITOR.basePath + '../../backend/lfm?type=Files';
	config.filebrowserImageBrowseUrl = CKEDITOR.basePath + '../../backend/lfm?type=Images';
	config.filebrowserFlashBrowseUrl = CKEDITOR.basePath + '../../backend/lfm?type=Files';
